							...
							<div class="col-md-12 articles clearfix" id="layout-page">
								...
								<div class="news-content">
									...
									<div class="col-xs-12 col-sm-12 hidden-lg hidden-md">
										...
										<h2 class="title-article"><a href="{{ route('blogs.read',['cat'=>$n->cat_news->name_ascii, 'slug'=>$n->title_ascii]) }}">{{$n->title}}</a></h2>
									...
									<div class=" col-md-5  hidden-xs hidden-sm">
										...
										<div class="body-content">
											<ul class="info-more">
												<li><i class="icon-info icon-hot clearfix"></i> <a href="#"> {{ $n->cat_news->name }}	</a> </li>
											</ul>
											<p>{{$n->quote}}</p>
										</div>
										<!-- End: Nội dung bài viết -->	
										<a class="readmore clear-fix" href="{{ route('blogs.read',['cat'=>$n->cat_news->name_ascii, 'slug'=>$n->title_ascii]) }}" role="button">Xem tiếp <span class="fa fa-angle-double-right"></span></a>
									</div>
