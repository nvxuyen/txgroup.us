						...
						<div class="row">
							<div class="col-xs-12">
							  ...
							  @endif
								...
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="{{route('adm.slider.edit',['id'=>'$slider->id'])}}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<div id="image_pre"><img id="slider_image" src="{{ asset('public/assets/images/slider') }}/{{ $slider->image }}" /></div>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="link" value="{{ $slider->link }}" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="alt" value="{{ $slider->alt }}" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
...
<script type="text/javascript">
  $("#uploadFile").change(function(){
     ...
     if(total_file > 0){
     	document.getElementById("image_pre").style.display = "none";
     }
